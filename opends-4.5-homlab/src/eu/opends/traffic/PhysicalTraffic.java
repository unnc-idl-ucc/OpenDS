...
public class PhysicalTraffic extends Thread
{
	...
	public PhysicalTraffic(Simulator sim)
	{
		...
		for(TrafficCarData vehicleData : vehicleDataList)
		{
			...
			TrafficCar newCar = new TrafficCar(sim, vehicleData);
			trafficObjectList.add(newCar);
		}
	...
	public void update(float tpf)
	{
		if (getMultiThreadingEnable()){
			//System.out.println("I've not think about multithreading case in PhysicalTraffic update");
...
//				System.out.println(trafficObject.getName());		traffic object, without driver car /steeringCar is shown here.
