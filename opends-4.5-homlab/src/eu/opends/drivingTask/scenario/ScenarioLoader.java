...
public class ScenarioLoader 
{
	...
	// added by Yelly, to visualize near point/far point
	private String nearPointModelPath;
	private String farPointModelPath;
	public static float getMaxDistanceBetweenTwoIdealPoints() {
		return MAX_DISTANCE_BETWEEN_TWO_IDEAL_POINTS;
	}


	public DrivingTaskDataQuery getDtData() {
		return dtData;
	}


	public SimulationBasics getSim() {
		return sim;
	}
	...
	public float getDriverCarMass() {
		return driverCarMass;
	}


	public Vector3f getDriverCarStartLocation() {
		return driverCarStartLocation;
	}


	public Quaternion getDriverCarStartRotation() {
		return driverCarStartRotation;
	}


	public String getDriverCarModelPath() {
		return driverCarModelPath;
	}


	public String getNearPointModelPath() {
		return nearPointModelPath;
	}


	public String getFarPointModelPath() {
		return farPointModelPath;
	}
	...
	public List<TrafficLight> getGlobalTrafficLightList() {
...
*/	
	...
	public FollowBoxSettings getAutoPilotFollowBoxSettings() 
	{
		...
		try {
			...
			System.out.println("no autoPilot");
			return null;
			//e.printStackTrace();
		}
